...
class BoxesControllerTest < ActionController::TestCase
  ...
  test "should create box" do
    assert_difference('Box.count') do
      post :create, box: { description: @box.description, name: @box.name, owner_id: @box.owner_id, picture: @box.picture }
    end
  ...
  test "should update box" do
    put :update, id: @box, box: { description: @box.description, name: @box.name, owner_id: @box.owner_id, picture: @box.picture }
    assert_redirected_to box_path(assigns(:box))
  end
